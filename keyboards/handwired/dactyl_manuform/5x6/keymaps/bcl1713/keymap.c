...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_5x6(
        ...
        DM_RSTP , KC_Z    , KC_X    , KC_C    , KC_V    , KC_B    ,             KC_N    , KC_M    , KC_COMM , KC_DOT  , KC_SLSH , KC_BSLS ,
                            KC_LPRN , KC_RPRN ,                                                     KC_LBRC , KC_RBRC  ,
                                                RAISE   , KC_BSPC ,             KC_SPC  , LOWER   ,
                                                KC_HOME , SFT_ENT ,             SFT_ENT , KC_END  ,
                                                KC_DEL  , KC_LGUI ,             KC_RALT , LOWER
    ),
    ...
    [_LOWER] = LAYOUT_5x6(
        ...
        _______ , _______ , KC_WH_L , KC_WH_U , KC_WH_D , KC_WH_R ,             _______ , KC_1    , KC_2    , KC_3    , KC_PGDN , _______ ,
